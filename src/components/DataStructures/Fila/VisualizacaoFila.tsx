 ...
 *
 * @remarks
 * Interface principal para visualiza��o e manipula��o da estrutura de dados Fila.
 * Permite executar opera��es FIFO com feedback visual em tempo real.
 */
...
/**
 * Componente principal de visualiza��o da Fila
 *
...
const VisualizacaoFila: React.FC = () => {
  ...
  /**
   * Manipula a execu��o de um m�todo da fila
   *
    ...
    try {
      ...
      switch (metodoAtual) {
        ...
        case 'primeiro':
          ...
          break;
        case 'ultimo':
          mensagemSucesso = '�ltimo elemento visualizado';
          break;
        case 'tamanho':
          mensagemSucesso = 'Tamanho da fila consultado';
          break;
        case 'estaVazio':
          mensagemSucesso = 'Verifica��o de fila vazia realizada';
          break;
        case 'limpar':
          mensagemSucesso = 'Fila limpa com sucesso';
          break;
        case 'contem':
          mensagemSucesso = `Verifica��o de exist�ncia do elemento ${valor} realizada`;
          break;
        default:
          mensagemSucesso = 'Opera��o realizada com sucesso';
      }
  ...
  return (
    <div className="p-4 bg-gray-900 text-white min-h-screen">
      ...
      <span className="text-blue-400">8 m�todos dispon�veis</span>

      {/* Visualiza��o da fila (horizontal) */}
          ...
          {elementos.length > 0 ? (
            elementos.map((el, index) => (
              <li
                ...
                `}
                aria-label={`Elemento ${el.value} na posição ${index}${index === 0 ? ', frente da fila' : ''}${index === elementos.length - 1 ? ', final da fila' : ''}`}
              >
                {el.value}
              </li>
            ))
      ...
      <div className="bg-gray-800 p-4 rounded">
        <h3 className="text-lg font-bold mb-3">Hist�rico de Opera��es</h3>
        <div className="space-y-2 max-h-40 overflow-y-auto">
          {historico.length > 0 ? (
            ...
            <p className="text-gray-400 text-center py-2">Nenhuma opera��o executada ainda</p>
          )}
        </div>
      </div>
    </div>
