 ...
 *
 * @remarks
 * Interface principal para visualiza��o e manipula��o da estrutura de dados Pilha.
 * Permite executar opera��es LIFO com feedback visual em tempo real.
 */
...
/**
 * Componente principal de visualiza��o da Pilha
 *
...
const VisualizacaoPilha: React.FC = () => {
  ...
  /**
   * Manipula a execu��o de um m�todo da pilha
   *
    ...
    try {
      ...
      switch (metodoAtual) {
        ...
        case 'tamanho':
          ...
          break;
        case 'estaVazio':
          mensagemSucesso = 'Verifica��o de pilha vazia realizada';
          break;
        case 'limpar':
  ...
  return (
    <div className="p-4 bg-gray-900 text-white min-h-screen">
      ...
      <span className="text-rose-400">8 m�todos dispon�veis</span>

      {/* Visualiza��o da pilha (vertical) */}
